...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiCheckSquare } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const { data, error, isLoading } = useSWR<TeamInterface[]>(
    ...
    () => getTeams({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
