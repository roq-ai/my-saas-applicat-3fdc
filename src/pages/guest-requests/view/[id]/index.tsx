...
import { getGuestRequestById } from 'apiSdk/guest-requests';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Guest Request Detail View
          </Text>
          {hasAccess('guest_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/guest-requests/edit/${data?.id}`} passHref legacyBehavior>
              <Button
